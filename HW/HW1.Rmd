...
# Plot Likelihood -------------------------------------------------------------
likelihood.grid = dpois(sum_y, lambda = n * lambda.grid, log=F)

plot(x = lambda.grid, y = likelihood.grid,
...
lines(lambda.grid, priorpmf.grid, col='red') # prior

lines(lambda.grid, posteriorpmf.grid, col='blue') # posterior

lines(density(mainData$units), lty=2) # data

lines(lambda.grid, 20*likelihood.grid, col="green") # liklihood
